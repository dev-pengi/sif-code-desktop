...
import { ColoredCssIcon, ColoredJsIcon, ColoredJsonIcon, ColoredLessIcon, ColoredScssIcon } from "../../assets";
...
const filesCreate: FileCreate[] = [
  ...
  },
  {
    type: "scss",
    compileToType: "css",
    icon: ColoredScssIcon,
  },
  {
    type: "less",
    compileToType: "css",
    icon: ColoredLessIcon ,
    separate: true,
  },
  {
    type: "js",
